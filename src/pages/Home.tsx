...
const promos = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1683276123541-47f9cdbf1127?q=80&w=1587&auto=format&fit=crop",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1478144592103-25e218a04891?q=80&w=1470&auto=format&fit=crop",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1615996003711-555bd5759a3d?q=80&w=1470&auto=format&fit=crop",
...
const dishes = [
  {
    ...
    discount: 10,
    image:
      "https://images.unsplash.com/photo-1638431362735-687ebdce122e?q=80&w=1974&auto=format&fit=crop",
    isPopular: true,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    discount: 15,
    image:
      "https://images.unsplash.com/photo-1606755456206-b25206cde27e?q=80&w=1974&auto=format&fit=crop",
    isNew: true,
  },
  {
    id: "4",
    ...
    discount: 15,
    image:
      "https://images.unsplash.com/photo-1610970878459-a0e464d7592b?q=80&w=1924&auto=format&fit=crop",
    isVegetarian: true,
  },
];
      ...
      <main className="container px-4 pt-20">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-black text-gradient-party">
              Популярные комбо
            </h2>
            <Button
              variant="ghost"
        ...
        <div className="bg-gradient-party rounded-2xl p-5 mb-8 shadow-lg neon-shadow-purple">
          ...
          <p className="text-white/90 text-sm mb-3">
            Подпишись на наши обновления и получи приветственную скидку на
            первый заказ
          </p>
          <div className="flex gap-2">
            <Button
              size="sm"
              className="bg-white text-primary font-bold flex-1"
            >
              Подписаться
            </Button>
            <Button
              size="sm"
              variant="ghost"
              className="text-white border border-white/30 font-bold"
            >
              Потом
            </Button>
          </div>
